 ...
 * @module emdevif.util.ArrayTraitsAggregate
 * @author DuYicheng
 * @date 2025-07-24
 * @brief 数组特征的聚合类型
 */
...
export module emdevif.util.ArrayTraitsAggregate;

export namespace emdevif {

#ifndef EMDEVIF_UTIL_ARRAY_TRAITS_AGGREGATE_ADD_RESERVE_MEMBER
#define EMDEVIF_UTIL_ARRAY_TRAITS_AGGREGATE_ADD_RESERVE_MEMBER false
#endif
...
{
#if (EMDEVIF_UTIL_ARRAY_TRAITS_AGGREGATE_ADD_RESERVE_MEMBER)
private:

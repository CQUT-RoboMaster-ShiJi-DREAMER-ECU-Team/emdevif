...
TEST_SUIT(SysMessageSlotBasicTest)
{
    ...
    {
        emdevif::SysMessageSlot<int> slot = emdevif::SysMessageSlot<int>::create({.name = "BasicTestQueue"});
    ...
    {
        emdevif::SysMessageSlot<int> queue;
        static_assert(std::is_same_v<decltype(queue), emdevif::SysMessageSlot<int>>);
